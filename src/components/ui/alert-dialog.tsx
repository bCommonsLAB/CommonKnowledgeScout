...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // Z-Index hochsetzen, damit Dialoge in Overlays (Session Detail) nicht "dahinter" landen.
...
>(({ className, ...props }, ref) => (
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        // Z-Index über Overlay; sorgt für korrektes Stapeln in modalen Detailansichten.
