...
/**
 * GraphAdvancedSection — Experten-Encoding des Wissens-Graphen
 * (Welle 3-IV-UX, Petra-Review Punkt 3: aus der Explore-Seite in den
 * Bereich "Erweitert" verschoben).
 *
 * Kantenquellen und Knoten-Encodings (Groesse/Farbe/Deckkraft als
 * Meta-Feldnamen). Der einfache An/Aus-Schalter bleibt auf der
 * Explore-Seite (graph-config-section.tsx).
 */
...
interface GraphAdvancedSectionProps {
...
export function GraphAdvancedSection({ form }: GraphAdvancedSectionProps) {
  const { t } = useTranslation()

  return (
    <div className="space-y-4">
      <div className="border-b pb-2">
        <h3 className="text-lg font-semibold">Graph-Encoding</h3>
        <p className="text-sm text-muted-foreground">
          Kantenquellen und Knoten-Darstellung des Wissens-Graphen
          (Ein-/Ausschalten unter Explore).
        </p>
      </div>
          ...
          <FormItem>
            ...
            <Select
              ...
              onValueChange={(value) => {
                ...
                else console.warn('[GraphAdvancedSection] Ungültige Kantenquelle ignoriert:', value)
              }}
            >
              <FormControl>
                <SelectTrigger>
