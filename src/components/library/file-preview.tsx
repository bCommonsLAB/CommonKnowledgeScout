...
// View-Komponenten unter file-preview/views/* (Welle 3-II-a Phase 2a-2c):
...
// Weitere Views (markdown, office, presentation, website) folgen
// in Phase 2c-fortsetzung/2d — siehe AGENT-BRIEF.md.
