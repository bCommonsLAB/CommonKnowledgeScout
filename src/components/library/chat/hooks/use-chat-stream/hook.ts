/**
 * Hook-Implementierung fuer Chat-Stream-Verarbeitung.
 *
 * Typen sind in ./types.ts ausgegliedert (Welle 3-III-b).
 * Dieser Hook verwaltet das Senden von Fragen, SSE-Stream-Verarbeitung
 * und Step-Management. Wird nur im Chat verwendet.
 */
