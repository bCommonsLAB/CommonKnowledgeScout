...
import {
  ...
  explainStepLabelFromStep,
} from './debug-panel/helpers'
...
export function DebugPanel({ log }: { log: QueryLog }) {
  ...
  // simplifyLabel, getRetrieverLabel, recommendationMatches, explainStepLabelFromStep
  // sind in ./debug-panel/helpers.ts (Welle 3-III-b: Pure-Helper-Extraktion)

  // Hilfsfunktion für Antwortlänge-Label — benoetigt t() und bleibt in der Komponente
