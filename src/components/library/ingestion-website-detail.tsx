...
/**
 * Wrapper fuer WebsiteDetail (Landingpage als Dokument).
 *
 * Laedt die docMetaJson, veredelt sie mit der globalen UI-Locale via
 * `localizeDocMetaJson` und mappt sie auf WebsiteDetailData.
 * Strukturell identisch zu IngestionRefurbedDeviceDetail.
 */
export function IngestionWebsiteDetail({
  libraryId,
  fileId,
  fallbackLocale,
}: IngestionWebsiteDetailProps) {
  const { t, locale } = useTranslation();
  const [data, setData] = React.useState<WebsiteDetailData | null>(null);
  ...
  return <WebsiteDetail data={data} showBackLink={false} />;
}

export default IngestionWebsiteDetail;
