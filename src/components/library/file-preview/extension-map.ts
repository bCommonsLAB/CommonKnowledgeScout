...
// `getFileType` liegt seit M5 in `@ks/util` (die Anhang-Liste im Paket braucht
// ihn); hier re-exportiert, damit Archiv-Vorschau und Tests unveraendert bleiben.
export { getFileType } from '@ks/util'
