...
export function getDetailViewType(
  ...
  if (typeof frontmatterDetailViewType === 'string') {
    const validTypes: TemplatePreviewDetailViewType[] = ['book', 'session', 'testimonial', 'blog', 'climateAction', 'divaDocument', 'divaTexture', 'refurbedDevice']
  ...
  const validLibraryTypes: TemplatePreviewDetailViewType[] = ['book', 'session', 'testimonial', 'blog', 'climateAction', 'divaDocument', 'divaTexture', 'refurbedDevice']
