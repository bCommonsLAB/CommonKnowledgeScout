...
test('formatFileSize1: undefined and basic units', () => {
...
test('formatDateTime1: returns localized de-DE date string', () => {
...
test('getUserFriendlyAudioErrorMessage1: maps common network errors', () => {
...
test('getUserFriendlyVideoErrorMessage1: maps unsupported format', () => {
