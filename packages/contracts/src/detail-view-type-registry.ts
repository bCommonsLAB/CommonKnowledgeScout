...
/**
 * Die Werteliste selbst liegt in `./detail-view-type` — sie ist Teil des
...
export const VIEW_TYPE_REGISTRY: Record<DetailViewType, ViewTypeConfig> = {
  ...
  /** PBR-/Material-Textur (Template Diva-Texture-Analysis) — flaches snake_case-Schema (Stufe 2+, User-Entscheid 2026-05-28). */
  divaTexture: {
    requiredFields: ['title'],
    optionalFields: [
      'coverImageUrl',
      'slug',
      // Aus Pfad / Sidecar (deterministisch)
      'iln_nummer',
      'textur_code',
      'availability_scope',
      'retailer_iln',
      'group_name',
      // Pass 1 LLM: Klasse + Typ + Konfidenzen
      'material_class',
      'material_type',
      'confidence_class',
      'confidence_type',
      'needs_human_review',
      // Pass 1 LLM: visuelle Properties (User-Entscheid 2026-05-28: Voll-Pass)
      'dominant_color_hex',
      'color_family',
      'color_description',
      'surface_finish',
      ...
      'sprache',
      'docType',
      // Technische Bild-Metadaten (System-injiziert aus EXIF)
      'breite_px',
      'hoehe_px',
      'dpi_horizontal',
      'dpi_vertikal',
