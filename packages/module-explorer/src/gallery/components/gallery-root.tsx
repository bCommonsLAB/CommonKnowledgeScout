...
import { FilterContextBar } from './filter-context-bar'
import { GalleryStickyHeader } from './gallery-sticky-header'
import { FiltersPanel } from './filters-panel'
import { ViewTypeLeadFilter } from './view-type-lead-filter'
import { ItemsView } from './items-view'
import { GroupedItemsView } from './grouped-items-view'
import { groupDocsByReferences } from '../hooks/use-gallery-data'
...
import { useAllGalleryDocs } from '../hooks/use-all-gallery-docs'
import { useGalleryFacets } from '../hooks/use-gallery-facets'
import { useGallerySums } from '../hooks/use-gallery-sums'
...
const LazyDocGraph = lazy(() =>
  import('./graph/doc-graph').then((module) => ({ default: module.DocGraph }))
)
