...
todos:
  ...
  - id: enabler-leverage-concept
    content: "Stufe 4 (KONZEPT, User-Wunsch 2026-07-09 — Umsetzung erst nach Klaerung der restlichen Stolpersteine): Enabler-Hebel aus den Computed Relations. Kennzahl 'Hebelwirkung' pro Massnahme aus den gerichteten unterstuetzt/ermoeglicht-Kanten (doc_relations__<libraryId>): Enabler erben ANTEILIG die (Stufe-3-bereinigte) CO2-Wirkung der von ihnen aktivierten Massnahmen; Mehrfach-Enabler teilen sich die Wirkung (Gewichts-Normierung), Daempfung beta pro Hop; v1 nur 1 Hop. ENTSCHIEDEN 2026-07-09: beta-Default 0.5; KEINE Kosten-Vererbung (gesucht sind die Enabler mit der groessten zukuenftigen Wirkung, kostenunabhaengig). Eigene Wirkung und Hebelwirkung sind ZWEI GETRENNTE Kennzahlen (nie addieren — Doppelzaehlung). Bericht: pro Cluster die TOP-Hebel-Massnahmen. Details im Abschnitt 'Methodik (Stufe 4)'. UMGESETZT 2026-07-09: enabler-leverage.ts (pure, 10 Unit-Tests), overlap-report-leverage.ts (Kanten laden, hebel_* persistieren, Markdown-Abschnitt 'Hebel-Massnahmen' je Cluster inkl. Staleness-Note), Integration in phase-overlap-report; Live-Lauf gegen Prod: 594 Enabler, Top-Hebel Netzvorbereitung dezentrale Stromerzeugung (eigene 13,5 kt -> Hebel 105,7 kt). REVIDIERT 2026-07-11 (User-Entscheid): der Hebel-Abschnitt haengt NICHT mehr am Ende des Overlap-Berichts — der Enabler-Bericht ist EIGENSTAENDIG (kind 'enabler', enabler-report/recompute); die Integration in phase-overlap-report wurde entfernt. Zugleich UI-Umbenennung: 'Synergie-Bericht' -> 'Wirkungsbericht' (i18n reportButton/reportTitle in 5 Sprachen, Job-Label, Datei-Prefix, Default-Template-Titel). TEMPLATE-GETRIEBEN 2026-07-11 (User-Entscheid): BEIDE Berichte laufen ueber editierbare Vorlagen — Builtins 'bericht-wirkung' und 'bericht-enabler' (src/lib/templates/report-templates.ts, in der Vorlagenverwaltung sichtbar); Frontmatter = LLM-Feld-Schema, Body = Bericht-Layout mit Variablen (LLM-Felder + Code-Variablen wie ergebnis_tabelle/hebel_tabellen/kennzahlen, Methodik-Erklaertexte editierbar im Body), Systemprompt = Prompt-Design. Aufloesung: reportTemplateId -> gleichnamige Library-Kopie -> Builtin (report-template-resolver.ts). Der Enabler-Bericht hat damit einen LLM-Prosa-Pass (Cluster-Analyse in Prosa + Handlungsempfehlungen, Hebel-Rechnung bleibt deterministisch) und laeuft als external-job phase-enabler-report (nicht mehr synchron)."
    status: completed
